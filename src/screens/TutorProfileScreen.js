...
export default class TutorProfileScreen extends Component {
        ...
        return (
            <Container style={{backgroundColor:'#F5F5F5'}}>
                ...
                <Header style={{backgroundColor:'white', height: 80}}>
                    ...
                    <Right>
                        <Text style={{fontFamily: "AirbnbCerealLight", fontSize: 17}} onPress={()=>{Actions.BookTutorScreen()}}>
                            BACK
                        </Text>
                    </Right>
                </Header>
                ...
                <Content padder>
                    ...
                    <Button block last style={{marginTop: 70, backgroundColor:'#59C9A5'}} onPress={()=>{Actions.BookFormScreen();}}>
                        <Text style={{color:'black', fontFamily: "AirbnbCerealBlack", fontSize: 15}}>Book Tutor</Text>
                    </Button>
                    <Button block last style={{marginTop: 10, backgroundColor:'#59C9A5'}} onPress={()=>{Actions.ChatScreen();}}>
                        <Text style={{color:'black', fontFamily: "AirbnbCerealBlack", fontSize: 15}}>Chat with Tutor</Text>
                    </Button>
                </Content>
